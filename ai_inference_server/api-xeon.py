...
<h1>Upload an Image - Intel Xeon Platinum 8272cl Server</h1>
...
<h1>Prediction Result - Intel Xeon Platinum 8272cl Server</h1>
...
def predict():
    ...
    # Convert image to base64 to embed in HTML if needed
    ...
    if request.accept_mimetypes.accept_json:
        ...
        # Normal form POST from internal page
